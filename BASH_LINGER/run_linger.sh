...
SAMPLE_DATA_DIR="${OUTPUT_DIR}/timed_70_percent_sample_${SAMPLE_NUM}"
SAMPLE_OUTPUT_DIR="${OUTPUT_DIR}/timed_70_percent_sample_${SAMPLE_NUM}/"
SAMPLE_RESULTS_DIR="${RESULTS_DIR}/timed_70_percent_sample_${SAMPLE_NUM}"
