...
# Define paths for RNA and ATAC data (1000 - 5000 cell samples)
...
# 70 percent subsampled
RNA_DATA_PATH="${DATA_DIR}/70_percent_subsampled_RNA_${SAMPLE_NUM}.csv"
ATAC_DATA_PATH="${DATA_DIR}/70_percent_subsampled_ATAC_${SAMPLE_NUM}.csv"
SAMPLE_DATA_DIR="${OUTPUT_DIR}/70_percent_sample_${SAMPLE_NUM}"
SAMPLE_OUTPUT_DIR="${OUTPUT_DIR}/70_percent_sample_${SAMPLE_NUM}/"
SAMPLE_RESULTS_DIR="${RESULTS_DIR}/70_percent_sample_${SAMPLE_NUM}"
