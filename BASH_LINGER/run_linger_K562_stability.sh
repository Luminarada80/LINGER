...
scontrol update JobID=$SLURM_JOB_ID JobName=linger_K562_stability_${SAMPLE_NUM}
...
DATA_DIR="/gpfs/Labs/Uzun/DATA/PROJECTS/2024.GRN_BENCHMARKING.MOELLER/LINGER/LINGER_K562_STABILITY"
...
GROUND_TRUTH_PATH="${DATA_DIR}/RN117_ChIPSeq_PMID37486787_Human_K562.tsv"

# Paths in the results directory
RESULTS_DIR="/gpfs/Labs/Uzun/RESULTS/PROJECTS/2024.GRN_BENCHMARKING.MOELLER/LINGER/K562_STABILITY_RESULTS"
