...
karamveer_dir = "/gpfs/Labs/Uzun/DATA/PROJECTS/2024.GRN_BENCHMARKING.KARAMVEER/Macrophase_data"

outdir = "/gpfs/Labs/Uzun/DATA/PROJECTS/2024.GRN_BENCHMARKING.MOELLER/LINGER/LINGER_MACROPHAGE"
...
cat("Processing directory: ", basename(karamveer_dir), "\n")
rds_files <- list.files(karamveer_dir, pattern = "\\.rds$", full.names = TRUE)
